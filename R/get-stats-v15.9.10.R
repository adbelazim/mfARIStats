...
#' Esta función normaliza los templates del ARI propuesto por Asslid
#' @param time.instants
#' @param abp.signal
#' @param sample.release
#' @param sampling.time
#' @param baseline.initial.time
#' @param baseline.final.time
#' @param min.abp.max.delta.time
#' @param min.cbfv.max.delta.time
#' @param stabilisation.time
#' @param at.param.rounding.digits
#' @param normalised.cbfv.rounding.digits
#' @param time.tol
#'
#' @return Los templates de ARI normalizados
#'
#' @export
